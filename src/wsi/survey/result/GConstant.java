...
public class GConstant {
	...
	public final static int[] imgs = { R.drawable.img01, R.drawable.img02,
			R.drawable.img03, R.drawable.img04, R.drawable.img05, R.drawable.img06, R.drawable.img07};
	
	public final static int[] imgs_completed = { R.drawable.img01_completed, R.drawable.img02_completed,
		R.drawable.img03_completed, R.drawable.img04_completed, R.drawable.img05_completed,  R.drawable.img06_completed, R.drawable.img07_completed};
